/*
 *
 *   Â© Copyright 2018 - 2020 Visa. All Rights Reserved.
 *
 *   NOTICE: The software and accompanying information and documentation (together, the â€œSoftwareâ€�) remain the property of and are proprietary to Visa
 ...
 *  **THE SOFTWARE AND ANY ASSOCIATED INFORMATION OR DOCUMENTATION IS PROVIDED ON AN â€œAS IS,â€� â€œAS AVAILABLE,â€� â€œWITH ALL FAULTSâ€� BASIS WITHOUT WARRANTY OR  CONDITION OF ANY KIND. YOUR USE IS AT YOUR OWN RISK.**
 ...
 *  features are subject to Visaâ€™s terms and conditions and
 ...
 * schedules may be amended, updated or canceled at Visaâ€™s discretion.
 *  The timing of widespread availability of programs and functionality is also subject to a number of factors outside Visaâ€™s control,including but
